---
name: caro.discovery
description: Use this skill to run a structured user-discovery interview for Caro and save the transcript into docs/discovery/transcripts/ under the project's anonymization rules. Use when a new product line or major feature spec needs to clear Gate 1 of .Codex/rules/validation-discipline.md (the 20-transcripts rule). Also use to synthesize transcripts into the hypothesis ledger after each batch of 5 interviews. Triggers - "run a discovery interview for <feature>", "log this user conversation as a Caro discovery transcript", "synthesize this week's transcripts into the hypothesis ledger".
---
...
[`.Codex/rules/validation-discipline.md`](../../rules/validation-discipline.md),
...
- **It does not gate features by itself.** This skill produces the
  evidence; `.Codex/rules/validation-discipline.md` is the gate that
  uses the evidence.
