---
name: "source-command-automation-orchestrate"
description: "Migrated source command `automation.orchestrate`"
---

# source-command-automation-orchestrate

Use this skill when the user asks to run the migrated source command `automation.orchestrate`.
...
1. **Load Configuration**
   - Read `.Codex/automation/config/schedule.yaml`
   - Load state from `.Codex/automation/state/`
...
See `.Codex/automation/config/schedule.yaml` for full configuration options.
...
See [AUTOMATED_DEV_FLOW_DRS.md](../.Codex/automation/specs/AUTOMATED_DEV_FLOW_DRS.md) for complete specification.
