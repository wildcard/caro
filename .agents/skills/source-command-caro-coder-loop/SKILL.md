---
name: "source-command-caro-coder-loop"
...
# source-command-caro-coder-loop

Use this skill when the user asks to run the migrated source command `caro-coder-loop`.
...
Follow `.Codex/rules/git-workflow.md` — NEVER work on main.
...
**Conventions** (from /Users/kobik-private/workspace/caro/AGENTS.md):
...
**Apply the Good Boy Scout rule** (.Codex/rules/good-boy-scout.md) — fix obvious
...
- **Never work on main** — enforced by `.Codex/rules/git-workflow.md` hook.
