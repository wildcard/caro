---
name: "source-command-caro-context"
description: "Migrated source command `caro.context`"
---

# source-command-caro-context

Use this skill when the user asks to run the migrated source command `caro.context`.
