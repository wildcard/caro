---
name: "source-command-idea-sourcing-loop"
description: "Migrated source command `idea-sourcing-loop`"
---

# source-command-idea-sourcing-loop

Use this skill when the user asks to run the migrated source command `idea-sourcing-loop`.
...
Add to `.Codex/automation/queues/ideas_backlog.yaml`:
...
Daily Summary available at:
  .Codex/automation/state/idea_sourcing/2026-01-11.yaml
```
...
```yaml
# .Codex/automation/config/idea_sources.yaml
sources:
  reddit:
    enabled: true
    subreddits:
...
```yaml
# .Codex/automation/config/idea_sourcing.yaml
idea_sourcing:
  enabled: true
  schedule: "0 8 * * *"
...
- [IDEA_SOURCING_DRS.md](../.Codex/automation/specs/IDEA_SOURCING_DRS.md)
