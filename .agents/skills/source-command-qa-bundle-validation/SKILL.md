---
name: "source-command-qa-bundle-validation"
...
# source-command-qa-bundle-validation

Use this skill when the user asks to run the migrated source command `qa-bundle-validation`.
...
4. **Load Known Issues**
   - Read `.Codex/skills/quality-engineer-manager/references/known-issues.md`
...
3. **Create QA Sign-Off Artifact**
   - Save complete report to `.Codex/QA-SIGNOFF-BUNDLES-vX.Y.Z.md`
...
- **Beta Testing Playbook**: `.Codex/skills/quality-engineer-manager/references/beta-testing-playbook.md`
- **Beta Tester Profiles**: `.Codex/skills/unbiased-beta-tester/examples/preset-profiles.md`
- **Known Issues**: `.Codex/skills/quality-engineer-manager/references/known-issues.md`
- **QE Manager Skill**: `.Codex/skills/quality-engineer-manager/SKILL.md`
