---
name: "source-command-translator"
description: "Culturally-aware i18n translation with specialized sub-agents for each language"
---

# source-command-translator

Use this skill when the user asks to run the migrated source command `translator`.
...
3. PRESERVE brand names: "Caro", "Codex", "GitHub"
...
- **Cost**: Free (uses local Codex session)
...
Use API backends (OpenAI, Codex API) for:
