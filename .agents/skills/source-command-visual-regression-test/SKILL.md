---
name: "source-command-visual-regression-test"
description: "Migrated source command `visual-regression-test`"
---

# source-command-visual-regression-test

Use this skill when the user asks to run the migrated source command `visual-regression-test`.
...
```yaml
# .Codex/automation/config/visual_regression.yaml
visual_regression:
  enabled: true
...
- [VISUAL_REGRESSION_DRS.md](../.Codex/automation/specs/VISUAL_REGRESSION_DRS.md)
