...
| 2026-07-22 | PASS | PASS (1.5.0) | PASS | PASS | FLAKE/BUG | Model downloaded (~1.1 GB) but agent loop timed out; all runs return echo clarify (CPU stub bug #1277) |
...
| 10 | `caro ai --once` scripted conversational mode | ai | 2026-07-22 | FAIL | [#1334](https://github.com/wildcard/caro/issues/1334) |
