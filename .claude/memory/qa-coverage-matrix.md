...
| 2026-09-24 | PASS | PASS (1.5.0) | PASS | PASS | FAIL | Model downloaded (1.1GB), but CPU stub generates wrong cmd for all prompts — see #1473 |
...
| 10 | `caro ai --once` scripted conversational mode | ai | 2026-09-24 | FAIL | [#1473](https://github.com/wildcard/caro/issues/1473) |
...
| [#1473](https://github.com/wildcard/caro/issues/1473) | CPU embedded backend always returns "clarify" (system-prompt contamination) | embedded | 2026-09-24 | open |
| [#1474](https://github.com/wildcard/caro/issues/1474) | CLAUDE.md version 1.4.0 vs shipped 1.5.0 — regression of #1044 | docs | 2026-09-24 | open |
