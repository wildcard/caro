...
- 2026-05-25: observed twice more (Slot A dry-run + Slot C caro ai --once). Total: 3 observations but spread across 2 dates; check 7-day window on next run.

**Promotion threshold**: File regression issue if observed 3 times in 7 days (within a 7-day window) OR if it reproduces on a known-good environment with a pre-downloaded model. NOTE: 3 total observations now recorded across 2026-05-07 and 2026-05-25 (18 days apart) — does NOT meet the 7-day threshold. If observed again on or before 2026-06-01, promote to regression.  
