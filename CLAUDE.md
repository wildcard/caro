...
- [Agent Companion Guide](docs/coding-agents/README.md) - Overview and quick start
- [Agent Discovery Pipeline](docs/coding-agents/AGENT_DISCOVERY.md) - How new agents are added
