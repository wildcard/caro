    ...
    starlight({
      ...
      sidebar: [
        ...
        },
        {
          label: 'External Docs',
          collapsed: true,
          // Starlight v0.39.0 removed autogenerated sidebar *groups*; an
          // `autogenerate` config must now live inside a group's `items`
          // array rather than alongside `label`.
          items: [{ autogenerate: { directory: 'external' } }],
        },
      ],
      expressiveCode: {
