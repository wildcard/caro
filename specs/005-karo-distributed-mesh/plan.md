...
| **II. Library-First** | PASS | All mesh logic in `karo::mesh` library, CLI orchestrates |
...
```
specs/005-karo-distributed-mesh/
├── plan.md              # This file
...
```rust
/// Cryptographic identity of a Karo node (FR-101 through FR-105)
#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct NodeIdentity {
    /// Ed25519 public key, base64-encoded (32 bytes)
    /// Format: "karo:ed25519:<base64>"
    pub node_id: String,
...
pub struct NodeCapabilities {
    ...
    /// Karo software version
    pub karo_version: String,
...
pub struct SafetyStats {
    ...
    /// Commands generated by Karo
    pub karo_generated: u32,

    /// Karo commands that user executed
    pub karo_executed: u32,
}
...
*Based on Constitution v1.0.0 and ADR-002 (Karo System Definition)*
