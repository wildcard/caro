...
async fn main() {
    ...
    match validate_prompt(prompt_text) {
        ValidationAction::ShowHelp => {
            ...
            println!();
            println!("Commands:");
            println!("  init     Initialize or reconfigure Caro");
            println!("  status   Show system resources and current configuration");
            println!("  models   List available model tiers");
            println!();
            println!("Examples:");
            ...
            println!("  caro init           # Run interactive setup");
            println!("  caro init --auto    # Auto-configure based on resources");
            println!();
